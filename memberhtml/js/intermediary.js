...
intermediary={
    ...
    searchIntermediaryListShow:function(result){
        $.each(result,function(index,item){
            ...
            str+='<li class="contain-right-title-5">'+item.list[0].invitation_member_count+'</li>';
            ...
            str+='<li class="contain-right-title-14">'+item.list[0].invitation_refunds+'</li>';
            ...
            if(item.isIntermediary == 0 || item.isIntermediary == 1){
                str+='<li class="contain-right-title-13"><button class="agree" _id="'+item._id+'" _iid="'+item.list[0]._id+'">同意</button><button class="noagree" _id="'+item._id+'">拒绝</button></li>';
            }else if(item.isIntermediary == 2){
                str+='<li class="contain-right-title-13">已同意合伙人申请</li>';
            }else if(item.isIntermediary == 3){
                str+='<li class="contain-right-title-13">已拒绝合伙人申请</li>';
            }
        ...
        $('.agree').on('click',function(){  //同意合伙人申请
            ...
            var _iid=$(this).attr('_iid');
            comment.alert('确定同意合伙人申请？');
            $('.alert-bt-1').on('click',function(){
                comment.listAjax(urlList+'/agreeIntermediary',{_id:_id,_iid:_iid},function(data){
                    alert('合伙人同意成功');
                    $('.alert').css({
                        display:'none'
                    })
